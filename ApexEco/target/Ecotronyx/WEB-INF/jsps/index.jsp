...
<script type="text/javascript">
	...
	function handler(msg, textStatus, jqXHR) {
		...
		//alert("status " + status);
		if (status == 200) {
			//alert("messages in handler class " + msg);
			...
			$(function() {
				...
				//alert("weekDaysLength.."+weekDaysLength.length);
				/*first week end data*/
									...
									plotOptions : {
										...
										series : {
											...
											point : {
												events : {
													click : function() {
														// alert ('DayOfMonth: '+ this.x +', Megawats: '+ this.y);
