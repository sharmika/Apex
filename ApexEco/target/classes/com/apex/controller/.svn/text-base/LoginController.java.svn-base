...
public class LoginController {
	...
	public @ResponseBody
	String loginForum(ModelMap model, HttpServletRequest request,
		...
		try {
			 ...
			 * String
			 */
			ChatDetails = loginBO.getChartDetails(yearMonth);
		} catch (Exception e) {
	...
	String dayAheadPosition(ModelMap model, HttpServletRequest request,
		...
		try {
			 ...
			 * related json String
			 */
			ChatDetails = loginBO.getDayAheadChartDetails(dayValue,
					megaWattValue);
