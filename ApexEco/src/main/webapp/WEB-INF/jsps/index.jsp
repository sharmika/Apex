						...
						.highcharts(
								{
									...
									yAxis : [ { // Primary yAxis
									 ...
									 /* Tooltip for the chart*/
									   ...
									   tooltip: {
										   ...
										   shared: true,
										    formatter: function() {
								                var s = Highcharts.dateFormat('%A, %b %e,',this.x) +'\t'+year;
									...
									series : [
											...
											},
											{
											 ...
											 /*{
												type : 'column',
												name : 'Available Demand Response1 ',
												showInLegend : availableBoolValue,
												data : availableDemandStackBar,
												color : 'rgba(132,132,132,0.8)',
												pointWidth : 35,
											...
											{
												type : 'column',
												name : 'Scheduled Demand Response1 ',
												showInLegend : scheduledBoolValue,
												data : scheduledDemandStackBar,
												color : 'rgba(45,45,45,0.8)',
												pointWidth : 35,
