...
public class ApexUtility {
	...
	public String getChartDetailsFromJson(String yearMonth) {
		...
		/*
		 * hedged,proposed,scheduled,availabe StackBarMap objects for placing
		 ...
		 * array contains [xarray,linedata]
		 */
		 ...
		 * form of array contains [xarray,hedgedStackBardata]
		 */
		 ...
		 * form of array contains [xarray,proposedStackBardata]
		 */
		 ...
		 * in the form of array contains [xarray,scheduledDemandStackBardata]
		 */
		String scheduledDemandStackBar = ApexUtility.getChartData(xArray,
				scheduledDemandStackBarArray, "scheduledDemandStackBar");
		/*
		 * calling getChartData() and that returns scheduledDemandStackBar data
		 * in the form of array contains [xarray,availableDemandStackBarData]
		 */
		 ...
		 * array contains [xarray,averagesData]
		 */
		 ...
		 * form of array contains [xarray,rangesData]
		 */
	...
	private static String getChartData(Long[] xArray, Double[] yArray,
		 ...
		 * xAxis increament value and yInc for yAxis increment value.
		 */
		...
		/* praparing chart data in the form of array. */
